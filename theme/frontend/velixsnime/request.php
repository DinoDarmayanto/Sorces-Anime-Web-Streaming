    ...
    <section class="hero py-1">
        ...
        <div class="container py-5 z-index-20 position-relative">
            <div class="row align-items-center mt-2">
                <div class="col">
                    <h1 class="text-light">Request Anime</h1>
                    <p class="text-light">Request Anime Streaming Atau Link Download.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12 col-xl-8 col-lg-8">
                    <div class="card rounded-0 mb-3">
                        <div class="card-body">
                            <div align="center">
                                <img class="card-img mb-3 " style="width: 50%;" src="<?= _frontEnd($websettings->theme_active) ?>img/req.png" alt="Velixsnime">
                            </div>
                            ...
                            <form action="" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control border-0" name="email" placeholder="Masukan email kamu" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label">Request</label>
                                    <textarea class="form-control border-0" name="pesan" rows="5" placeholder="Masukan Judul anime yang anda inginkan" required></textarea>
                                </div>
                                <div align="center">
